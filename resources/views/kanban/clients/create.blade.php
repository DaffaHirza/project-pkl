...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Isi data klien dengan lengkap</p>
    </div>

    {{-- Form --}}
    <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
        <form action="{{ route('kanban.clients.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="3"
                              class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent @error('address') border-red-500 @enderror"
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
                <a href="{{ route('kanban.clients.index') }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition">
                    Batal
                </a>
