...
<div>
    {{-- Header --}}
    <div class="mb-6">
        <a href="{{ route('kanban.clients.debitur') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 mb-2">
