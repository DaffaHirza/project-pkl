...
<div class="w-full flex items-center py-5 justify-between dark:border-gray-700">
    <div class="flex flex-col">
        ...
        <span class="text-xs text-gray-400">Analisis dilakukan pada: </span>
    </div>
</div>
{{-- End Page Header AI --}}
{{-- Card AI --}}
                            ...
                            <td class="size-px whitespace-nowrap align-top">
                                <a class="block p-6">
                                    ...
                                    @elseif ($item->status_verifikasi === 'tidak_ditemukan')
                                        <span
                                            class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-error-100 text-error-800 rounded-full dark:bg-error-500/10 dark:text-error-500">
                                            Tidak Ditemukan
                                        </span>
                                    @else
                                        <span
                ...
                @else
                    <tr class="bg-white hover:bg-gray-50 dark:bg-neutral-900 dark:hover:bg-neutral-800">
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-neutral-400">
                            Tidak ada hasil analisis AI yang tersedia.
                        </td>
                    </tr>
                @endif
            </tbody>
...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6 py-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="text-center">
            <p class="text-green-600 font-semibold text-lg">{{ $hasil ? $hasil->status_label : 'Belum Dianalisis' }}</p>
        </div>
    </div>
