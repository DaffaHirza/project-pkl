...
<body class="font-sans antialiased bg-white dark:bg-gray-900">
    <!-- Navigation -->
    <nav
        class="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <!-- Logo -->
                <div class="flex items-center gap-3">
                    <img src="{{ asset('images/image.png') }}" alt="Logo Kantor Jasa Penilai Publik"
                        class="h-10 w-auto" />
                    ...
                    <div class="flex items-center gap-3">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="px-4 py-2 text-sm font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 transition-colors shadow-sm shadow-brand-500/30">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}"
    ...
    {{-- <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        <!-- Background Pattern -->
        <div
            class="absolute inset-0 bg-gradient-to-br from-ocean-50 via-white to-brand-50 dark:from-gray-900 dark:via-gray-dark dark:to-gray-900">
        </div>
        <div class="absolute inset-0 opacity-30">
            <div
                class="absolute top-20 left-10 w-72 h-72 bg-ocean-200 rounded-full mix-blend-multiply filter blur-xl animate-pulse">
            </div>
            <div
                class="absolute top-40 right-10 w-72 h-72 bg-brand-300 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000">
            </div>
            <div
                class="absolute bottom-20 left-1/2 w-72 h-72 bg-brand-200 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-500">
            </div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                <!-- Badge -->
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 bg-brand-100 dark:bg-brand-500/20 rounded-full mb-6">
                    <span class="w-2 h-2 bg-brand-500 rounded-full animate-pulse"></span>
                    <span class="text-sm font-medium text-brand-700 dark:text-brand-300">Kantor Jasa Penilai Publik
                        Terpercaya</span>
                </div>
                ...
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10">
                    Menyediakan layanan jasa penilaian aset profesional dengan standar kualitas tinggi dan integritas
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="w-full sm:w-auto px-8 py-3.5 text-base font-medium text-white bg-brand-500 rounded-xl hover:bg-brand-600 transition-all shadow-lg shadow-brand-500/30 hover:shadow-xl hover:shadow-brand-500/40 hover:-translate-y-0.5">
                            Buka Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                        ...
                        <a href="#services"
                            class="w-full sm:w-auto px-8 py-3.5 text-base font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all border border-gray-200 dark:border-gray-700">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div class="absolute inset-0">
            <img src="{{ asset('images/kjpp-semarang.jpg') }}" alt="KJPP Mushofah dan Rekan"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                ...
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-6 border border-white/20">
                    <span class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                    <span class="text-sm font-medium text-white">
                        Kantor Jasa Penilai Publik Terpercaya
                    </span>
                </div>
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                    KJPP Mushofah
                    <br>
                    <span class="text-brand-400">dan Rekan</span>
                </h1>
                ...
                <p class="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-10">
                    Menyediakan layanan jasa penilaian aset profesional dengan standar
                    kualitas tinggi dan integritas untuk mendukung kebutuhan bisnis Anda.
                </p>

                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="{{ route('login') }}"
                        class="px-8 py-3.5 text-white bg-brand-500 rounded-xl hover:bg-brand-600 transition-all">
                        Mulai Sekarang
                    </a>

                    <a href="#services"
                        class="px-8 py-3.5 text-white border border-white/30 bg-white/10 backdrop-blur-md rounded-xl hover:bg-white/20 transition-all">
                        Pelajari Lebih Lanjut
                    </a>
                </div>
    ...
    <section id="services" class="py-20 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mt-2 mb-4">Jasa Penilaian
                    Profesional</h2>
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                    Kami menyediakan berbagai layanan penilaian aset yang komprehensif untuk memenuhi kebutuhan bisnis
                    dan personal Anda.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Service Card 1 -->
                <div
                    class="group p-8 bg-gray-50 dark:bg-gray-800 rounded-2xl hover:bg-brand-500 transition-all duration-300 hover:shadow-xl hover:shadow-brand-500/20 hover:-translate-y-1">
                    <div
                        class="w-14 h-14 bg-brand-100 dark:bg-brand-500/20 group-hover:bg-white/20 rounded-xl flex items-center justify-center mb-6 transition-colors">
                        <svg class="w-7 h-7 text-brand-500 group-hover:text-white transition-colors" fill="none"
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 dark:text-white group-hover:text-white mb-3 transition-colors">
                        Penilaian Properti</h3>
                    <p class="text-gray-600 dark:text-gray-400 group-hover:text-white/80 transition-colors">
                        Penilaian properti komersial, residensial, dan industrial dengan metode yang sesuai standar
                        internasional.
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3
                        class="text-xl font-semibold text-gray-900 dark:text-white group-hover:text-white mb-3 transition-colors">
                        Penilaian Aset Tak Berwujud</h3>
                    <p class="text-gray-600 dark:text-gray-400 group-hover:text-white/80 transition-colors">
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <span class="text-brand-500 font-medium text-sm uppercase tracking-wider">Mengapa Memilih
                        Kami</span>
                    <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mt-2 mb-6">Keunggulan
                        Layanan Kami</h2>
                    <p class="text-gray-600 dark:text-gray-400 mb-8">
                        Dengan pengalaman bertahun-tahun dan tim profesional bersertifikasi, kami berkomitmen memberikan
                        layanan penilaian terbaik.
                    </p>

                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 bg-brand-100 dark:bg-brand-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Profesional Bersertifikasi
                                </h4>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Tim penilai kami memiliki
                                    sertifikasi resmi dan terdaftar di MAPPI.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Metodologi penilaian sesuai dengan
                                    International Valuation Standards (IVS).</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Pelayanan Cepat & Akurat
                                </h4>
                                <p class="text-gray-600 dark:text-gray-400 text-sm">Proses penilaian efisien dengan
                                    hasil yang akurat dan dapat diandalkan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div
                        class="absolute -bottom-4 -right-4 w-full h-full bg-brand-200 dark:bg-brand-900 rounded-2xl -z-10">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-ocean-500">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-ocean-100 text-lg mb-8 max-w-2xl mx-auto">
                Hubungi kami sekarang untuk konsultasi gratis dan dapatkan penawaran terbaik untuk kebutuhan penilaian
                aset Anda.
            </p>
            @auth
                <a href="{{ url('/dashboard') }}"
                    class="inline-flex items-center px-8 py-3.5 text-base font-medium text-brand-600 bg-white rounded-xl hover:bg-brand-50 transition-all shadow-lg">
                    Buka Dashboard
