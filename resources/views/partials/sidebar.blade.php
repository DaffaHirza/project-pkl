    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        @php
            ...
            $activeMenu = match(true) {
                ...
                str_starts_with($currentRoute, 'assistant') => 'Assistant',
                    ...
                    <li>
                        <a href="{{ route('assistant.index') }}" @click="selected = 'AI Assistant'"
                            ...
                            <svg class="w-5 h-5 transition-colors duration-300"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 2.43L10 3.00006L8 2.99994L8.00009 1.59801L8.27826 1.3079C8.52078 1.05498 8.88254 0.687155 9.51489 0.412789C10.1265 0.147442 10.9151 0 12 0C13.085 0 13.8736 0.147454 14.4852 0.412808C15.1175 0.687178 15.4793 1.055 15.7218 1.30788L16 1.59802V3H14V2.42998C13.9115 2.36092 13.8144 2.30192 13.6891 2.24754C13.4093 2.12611 12.9151 2 12 2C11.085 2 10.5908 2.12611 10.3109 2.24754C10.1856 2.30192 10.0886 2.36092 10 2.43Z" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.0005 17C10.8097 17.0006 9.59337 16.695 8.4 15.8L9.6 14.2C10.4066 14.805 11.1886 15.0004 11.9995 15C12.8103 14.9996 13.594 14.8045 14.4 14.2L15.6 15.8C14.406 16.6955 13.1879 16.9994 12.0005 17Z" />
                                <path d="M7 11.5C7 10.6716 7.67157 10 8.5 10C9.32843 10 10 10.6716 10 11.5C10 12.3284 9.32843 13 8.5 13C7.67157 13 7 12.3284 7 11.5Z" />
